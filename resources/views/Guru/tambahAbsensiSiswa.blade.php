                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <form action="/Guru/tambahabsensiview" method = "POST">
                                    ...
                                    <button type="submit" class = "btn btn-primary"> <i class = "fa fa-plus"></i> Tambah Absensi</button>
                                </form>
                                <br>
                                ...
                                <form action="/Guru/lihatNilai" method = "POST">
                                    ...
                                    <button type="submit" class = "btn btn-success"> <i class = "fa fa-eye"></i> Lihat Absensi</button>
                                </form>
